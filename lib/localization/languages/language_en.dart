...
final Map<String, String> enUS = {
  ...
  EnumLocal.txtOnBoardingSubTitle_1.name:
      "Experience the future of social media with our cutting-edge features and intuitive design. Get ready to connect, share, and discover like never before!",
  EnumLocal.txtOnBoardingSubTitle_2.name:
      "Join a global community that's passionate, diverse, and vibrant. Connect with others, share your story, and make the world a smaller, more wonderful place!",
  EnumLocal.txtOnBoardingSubTitle_3.name:
      "From sharing life's moments to discovering new interests, our app has got you covered. Explore, create, and thrive in a world of endless possibilities!",
